...
import org.fixflow.service.FlowCenterService;
import org.fixflow.shell.CommonServiceImpl;
import org.fixflow.shell.FixFlowShellProxy;
import org.fixflow.shell.FlowUtilServiceImpl;
import org.fixflow.util.FileUtil;
import org.fixflow.util.ImageCutUtil;
import org.fixflow.util.JSONUtil;
import org.fixflow.util.Pagination;
...
public class FlowCenterServiceImpl extends CommonServiceImpl implements FlowCenterService {
	...
	/*
	  ...
	  * @return
	  * @throws SQLException
	  * @see org.fixflow.service.FlowCenterService#queryMyTaskNotEnd(java.util.Map)
	  */
