...
import org.fixflow.bpmn.converter.FixFlowConverter;
...
import org.fixflow.core.impl.bpmn.behavior.TaskSubjectBehavior;
import org.fixflow.core.impl.util.BpmnModelUtil;
import org.fixflow.core.impl.util.EMFExtensionUtil;
...
import org.fixflow.editor.language.json.converter.BoundaryEventJsonConverter;
...
import org.fixflow.editor.language.json.converter.BusinessRuleTaskJsonConverter;
import org.fixflow.editor.language.json.converter.CallActivityJsonConverter;
import org.fixflow.editor.language.json.converter.CatchEventJsonConverter;
import org.fixflow.editor.language.json.converter.EndEventJsonConverter;
import org.fixflow.editor.language.json.converter.EventGatewayJsonConverter;
import org.fixflow.editor.language.json.converter.EventSubProcessJsonConverter;
import org.fixflow.editor.language.json.converter.ExclusiveGatewayJsonConverter;
import org.fixflow.editor.language.json.converter.InclusiveGatewayJsonConverter;
import org.fixflow.editor.language.json.converter.ManualTaskJsonConverter;
import org.fixflow.editor.language.json.converter.ParallelGatewayJsonConverter;
import org.fixflow.editor.language.json.converter.ReceiveTaskJsonConverter;
...
import org.fixflow.editor.language.json.converter.ServiceTaskJsonConverter;
...
import org.fixflow.editor.language.json.converter.ThrowEventJsonConverter;
...
public class BpmnJsonConverter implements EditorJsonConstants, StencilConstants, ActivityProcessor {
  ...
  public Definitions convertToBpmnModel(JsonNode modelNode) {
	  ...
	  InputStream inputStream = this.getClass().getClassLoader().getResourceAsStream("org/fixflow/editor/language/node_template.bpmn");
