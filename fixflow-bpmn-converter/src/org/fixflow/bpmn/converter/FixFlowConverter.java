 ...
 * @author ych
 */
package org.fixflow.bpmn.converter;
...
public class FixFlowConverter {
	...
	public void createBPMNFile(String path,String processId,String processName){
		...
		String filePath = "org/fixflow/editor/language/default_process.bpmn";
		try {
	...
	public Definitions getNoneDefinitions(){
		...
		String filePath = "org/fixflow/editor/language/node_template.bpmn";
		try {
			InputStream in = null;
			...
			throw new FixFlowException("读取node_template.bpmnc出错，请检查org/fixflow/editor/language/node_template.bpmn是否存在");
		}
