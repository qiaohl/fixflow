...
import org.fixflow.core.ConnectionManagement;
import org.fixflow.core.FormService;
import org.fixflow.core.HistoryService;
import org.fixflow.core.IdentityService;
import org.fixflow.core.ManagementService;
import org.fixflow.core.ModelService;
import org.fixflow.core.ProcessEngine;
import org.fixflow.core.ProcessEngineConfiguration;
import org.fixflow.core.RuntimeService;
import org.fixflow.core.ScheduleService;
import org.fixflow.core.TaskService;
import org.fixflow.core.cache.CacheHandler;
import org.fixflow.core.database.DataBaseTableEnum;
import org.fixflow.core.db.pagination.Pagination;
import org.fixflow.core.exception.FixFlowException;
import org.fixflow.core.impl.cache.CacheImpl;
import org.fixflow.core.impl.db.DbConfig;
import org.fixflow.core.impl.db.DbType;
import org.fixflow.core.impl.filter.AbstractCommandFilter;
import org.fixflow.core.impl.identity.AbstractAuthentication;
import org.fixflow.core.impl.identity.GroupDefinition;
import org.fixflow.core.impl.identity.UserDefinition;
import org.fixflow.core.impl.interceptor.CommandContextFactory;
import org.fixflow.core.impl.interceptor.CommandContextInterceptor;
import org.fixflow.core.impl.interceptor.CommandExecutor;
import org.fixflow.core.impl.interceptor.CommandExecutorImpl;
import org.fixflow.core.impl.jms.MessageReceiver;
import org.fixflow.core.impl.message.FlowMessageListener;
import org.fixflow.core.impl.persistence.deployer.BpmnDeployer;
import org.fixflow.core.impl.persistence.deployer.Deployer;
import org.fixflow.core.impl.persistence.deployer.DeploymentCache;
import org.fixflow.core.impl.processversion.FixFlowVersion;
import org.fixflow.core.impl.threadpool.FixThreadPoolExecutor;
...
import org.fixflow.model.coreconfig.ImportDataVariableConfig;
import org.fixflow.model.coreconfig.InternationalizationConfig;
import org.fixflow.model.coreconfig.PigeonholeConfig;
...
import org.fixflow.model.coreconfig.ResourcePathConfig;
import org.fixflow.model.coreconfig.RulesResource;
import org.fixflow.model.coreconfig.RulesResourceConfig;
...
import org.fixflow.model.sqlmappingconfig.BusinessRules;
import org.fixflow.model.sqlmappingconfig.Column;
import org.fixflow.model.sqlmappingconfig.DataBaseTable;
import org.fixflow.model.sqlmappingconfig.Delete;
import org.fixflow.model.sqlmappingconfig.Insert;
...
import org.fixflow.model.sqlmappingconfig.SqlmappingconfigFactory;
import org.fixflow.model.sqlmappingconfig.Update;
import org.fixflow.model.variableconfig.DataVariableConfig;
import org.fixflow.model.variableconfig.VariableconfigPackage;
...
public class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {
	...
	private void initDataVariableConfig() {
		...
		String classPath = "org/fixflow/expand/config/datavariableconfig.xml";
	...
	protected void initEmfFile() {
		...
		InputStream inputStream = null;
		String classPath = "org/fixflow/expand/config/fixflowconfig.xml";
	...
	protected void initUserDefinition() {
		...
		UserDefinition userDefinitionObj = (UserDefinition) ReflectUtil.instantiate("org.fixflow.expand.identity.UserDefinitionImpl");
	...
	protected void initQuartz() {
		...
		if (quartzDataBase.getDbtype().equals(DBType.ORACLE)) {
			driverDelegateClass = "org.fixflow.expand.quartz.jdbcjobstore.oracle.OracleDelegate";
			// driverDelegateClass =
		...
		// JobStoreTX
		props.put("org.quartz.jobStore.class", "org.fixflow.expand.quartz.jdbcjobstore.JobStoreFix");
		...
		if (inputStream == null) {
			try {
				inputStream = ReflectUtil.getResourceAsStream("org/fixflow/expand/config/quartz.properties");
				if (inputStream != null) {
					prop.load(inputStream);
					inputStream.close();
					Set<Object> objects = prop.keySet();
				...
				System.out.println("org/fixflow/expand/config/根目录未找到quartz.properties文件");
			}
		}
