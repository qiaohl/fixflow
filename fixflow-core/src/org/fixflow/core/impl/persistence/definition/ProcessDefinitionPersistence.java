 ...
 * @author kenshin
 */
package org.fixflow.core.impl.persistence.definition;
...
import org.fixflow.core.impl.ProcessDefinitionQueryImpl;
import org.fixflow.core.impl.bpmn.behavior.DataVariableBehavior;
...
import org.fixflow.core.impl.datavariable.DataVariableMgmtDefinition;
import org.fixflow.core.impl.db.PersistentObject;
import org.fixflow.core.impl.db.SqlCommand;
import org.fixflow.core.impl.event.BaseElementEventImpl;
	...
	private ProcessDefinitionBehavior getProcessDefinition(Map<String, Object> processDataMap) {
		...
		if (processDefinition == null) {
			...
			if (bytesObject != null) {
				...
				String filePath = this.getClass().getClassLoader().getResource("org/fixflow/expand/config/fixflowfile.bpmn").toString();
				Resource ddddResource = null;
				if (!filePath.startsWith("jar")) {
					try {
						filePath = java.net.URLDecoder.decode(ReflectUtil.getResource("org/fixflow/expand/config/fixflowfile.bpmn").getFile(),
								"utf-8");
