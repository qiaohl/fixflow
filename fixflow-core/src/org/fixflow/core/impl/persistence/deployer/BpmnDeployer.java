 ...
 * @author kenshin
 */
package org.fixflow.core.impl.persistence.deployer;
...
public class BpmnDeployer implements Deployer {
	...
	public void deploy(DeploymentEntity deployment) {
		...
		if (!filePath.startsWith("jar")) {
			try {
				filePath = java.net.URLDecoder.decode(ReflectUtil.getResource("org/fixflow/expand/config/fixflowfile.bpmn").getFile(), "utf-8");
